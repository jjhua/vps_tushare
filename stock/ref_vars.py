...
LHB_TMP_COLS = [
    'SCode', 'SName', 'Chgradio', 'ZeMoney', 'Bmoney', 'Smoney', 'Ctypedes',
    'Turnover'
]
LHB_COLS = [
    'code', 'name', 'pchange', 'amount', 'buy', 'sell', 'reason', 'Turnover'
]
...
TERMINATED_T_COLS = [
    'COMPANY_CODE', 'COMPANY_ABBR', 'LISTING_DATE', 'CHANGE_DATE'
]
...
FUND_HOLDS_COLS = [
    'count', 'clast', 'date', 'ratio', 'amount', 'nums', 'nlast', 'name',
    'code'
]
NEW_STOCKS_COLS = [
...
MAR_SH_MX_COLS = [
    'opDate', 'stockCode', 'securityAbbr', 'rzye', 'rzmre', 'rzche', 'rqyl',
    'rqmcl', 'rqchl'
]
