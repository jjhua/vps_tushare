...
DAY_TRADING_COLUMNS = [
    'code', 'symbol', 'name', 'changepercent', 'trade', 'open', 'high', 'low',
...
LIVE_DATA_COLS = [
    ...
    'volume', 'amount', 'b1_v', 'b1_p', 'b2_v', 'b2_p', 'b3_v', 'b3_p', 'b4_v',
    'b4_p', 'b5_v', 'b5_p', 'a1_v', 'a1_p', 'a2_v', 'a2_p', 'a3_v', 'a3_p',
...
QUOTE_COLS = [
    'date', 'bank', 'ON_B', 'ON_A', '1W_B', '1W_A', '2W_B', '2W_A', '1M_B',
    '1M_A', '3M_B', '3M_A', '6M_B', '6M_A', '9M_B', '9M_A', '1Y_B', '1Y_A'
]
SHIBOR_MA_COLS = [
    'date', 'ON_5', 'ON_10', 'ON_20', '1W_5', '1W_10', '1W_20', '2W_5',
    '2W_10', '2W_20', '1M_5', '1M_10', '1M_20', '3M_5', '3M_10', '3M_20',
    '6M_5', '6M_10', '6M_20', '9M_5', '9M_10', '9M_20', '1Y_5', '1Y_10',
    '1Y_20'
]
LPR_COLS = ['date', '1Y']
...
PROFIT_DIVIS = [
    'code', 'name', 'year', 'bshares', 'incshares', 'totals', 'cash',
    'plandate', 'regdate', 'exdate', 'eventproc', 'anndate'
]
...
def _check_input(year, quarter):
    ...
    elif quarter is None or isinstance(quarter,
                                       str) or quarter not in [1, 2, 3, 4]:
...
def _code_to_symbol_dgt(code):
    ...
    if code in INDEX_LABELS:
        ...
        if len(code) != 6:
            ...
            return '0%s' % code if code[:1] in ['5', '6',
                                                '9'] else '1%s' % code
