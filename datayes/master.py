...
class Master():
    ...
    def SecID(self, assetClass='', cnSpell='', partyID='', ticker='',
              field=''):
        """
        ...
        """
        code, result = self.client.getData(vs.SECID % (assetClass, cnSpell,
                                                       partyID, ticker, field))
    ...
    def Industry(self,
        ...
        """
        code, result = self.client.getData(vs.INDUSTRY %
                                           (industryVersion, industryVersionCD,
    ...
    def SecTypeRel(self, secID='', ticker='', typeID='', field=''):
        ...
        """
        code, result = self.client.getData(vs.SECTYPEREL % (secID, ticker,
                                                            typeID, field))
        return _ret_data(code, result)
    ...
    def SysCode(self, codeTypeID='', valueCD='', field=''):
        ...
        """
        code, result = self.client.getData(vs.SYSCODE % (codeTypeID, valueCD,
                                                         field))
        return _ret_data(code, result)
