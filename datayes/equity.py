...
class Equity():
    ...
    def Equ(self, equTypeCD='', secID='', ticker='', listStatusCD='',
            field=''):
        """
            获取股票的基本信息，包含股票交易代码及其简称、股票类型、上市状态、上市板块、上市日期等；上市状态为最新数据，不显示历史变动信息。
        """
        code, result = self.client.getData(vs.EQU % (equTypeCD, secID, ticker,
                                                     listStatusCD, field))
    ...
    def EquAllot(self,
        ...
        """
        code, result = self.client.getData(vs.EQUALLOT %
                                           (isAllotment, secID, ticker,
    ...
    def EquDiv(self,
        ...
        """
        code, result = self.client.getData(vs.EQUDIV %
                                           (eventProcessCD, exDivDate, secID,
    ...
    def EquIPO(self, eventProcessCD='', secID='', ticker='', field=''):
        ...
        """
        code, result = self.client.getData(vs.EQUIPO % (eventProcessCD, secID,
                                                        ticker, field))
        return _ret_data(code, result)
    ...
    def EquRef(self,
        ...
        """
        code, result = self.client.getData(vs.EQUREF %
