...
class Bond():
    ...
    def BondCoupon(self, secID='', ticker='', field=''):
        ...
        """
        code, result = self.client.getData(vs.BONDCOUPON % (secID, ticker,
                                                            field))
        return _ret_data(code, result)
    ...
    def BondGuar(self, secID='', ticker='', guarModeCD='', field=''):
        ...
        """
        code, result = self.client.getData(vs.BONDGUAR % (secID, ticker,
                                                          guarModeCD, field))
        return _ret_data(code, result)
    ...
    def BondIssue(self, secID='', ticker='', raiseModeCD='', field=''):
        ...
        """
        code, result = self.client.getData(vs.BONDISSUE % (secID, ticker,
                                                           raiseModeCD, field))
        return _ret_data(code, result)
    ...
    def BondOption(self, secID='', ticker='', field=''):
        ...
        """
        code, result = self.client.getData(vs.BONDOPTION % (secID, ticker,
                                                            field))
        return _ret_data(code, result)
