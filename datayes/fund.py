...
class Fund():
    ...
    def Fund(self,
        ...
        """
        code, result = self.client.getData(vs.FUND % (etfLof, listStatusCd,
                                                      secID, ticker, category,
                                                      operationMode, field))
    ...
    def FundDiv(self,
        ...
        """
            ...
            收录了2005年以来的历史数据，数据更新频率为不定期。
        """
        code, result = self.client.getData(vs.FUNDDIV %
                                           (secID, ticker, adjustedType,
    ...
    def FundAssets(self,
        ...
        """
        code, result = self.client.getData(vs.FUNDASSETS %
                                           (reportDate, secID, ticker,
                                            beginDate, endDate, field))
        return _ret_data(code, result)
    ...
    def FundHoldings(self,
        ...
        """
        code, result = self.client.getData(
            vs.FUNDHOLDINGS % (reportDate, secID, ticker, beginDate, endDate,
                               secType, field))
        return _ret_data(code, result)
