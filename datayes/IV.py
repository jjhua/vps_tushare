...
class IV():
    ...
    def DerIv(self, beginDate='', endDate='', optID='', SecID='', field=''):
        ...
        """
        code, result = self.client.getData(vs.DERIV % (beginDate, endDate,
                                                       optID, SecID, field))
    ...
    def DerIvHv(self, beginDate='', endDate='', SecID='', period='', field=''):
        ...
        """
        code, result = self.client.getData(vs.DERIVHV % (beginDate, endDate,
                                                         SecID, period, field))
        return _ret_data(code, result)
    ...
    def DerIvIndex(self,
        ...
        code, result = self.client.getData(
            vs.DERIVINDEX % (beginDate, endDate, SecID, period, field))
        return _ret_data(code, result)

    def DerIvIvpDelta(self,
                      beginDate='',
                      endDate='',
                      SecID='',
                      delta='',
        ...
        """
        code, result = self.client.getData(vs.DERIVIVPDELTA %
                                           (beginDate, endDate, SecID, delta,
                                            period, field))
        return _ret_data(code, result)
    ...
    def DerIvParam(self,
        ...
        """
        code, result = self.client.getData(
            vs.DERIVPARAM % (beginDate, endDate, SecID, expDate, field))
        return _ret_data(code, result)

    def DerIvRawDelta(self,
                      beginDate='',
                      endDate='',
                      SecID='',
                      delta='',
        ...
        """
        code, result = self.client.getData(vs.DERIVRAWDELTA %
                                           (beginDate, endDate, SecID, delta,
                                            period, field))
        return _ret_data(code, result)

    def DerIvSurface(self,
                     beginDate='',
                     endDate='',
                     SecID='',
                     contractType='',
        ...
        """
        code, result = self.client.getData(
            vs.DERIVSURFACE % (beginDate, endDate, SecID, contractType, field))
        return _ret_data(code, result)
