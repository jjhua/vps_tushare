...
class Subject():
    ...
    def SocialDataXQByTicker(self, ticker='', field=''):
        ...
        """
        code, result = self.client.getData(vs.SOCIALDATAXQBYTICKER % (ticker,
                                                                      field))
        return _ret_data(code, result)
    ...
    def NewsContentByTime(self,
        ...
        """
        code, result = self.client.getData(vs.NEWSCONTENTBYTIME %
                                           (newsPublishDate, beginTime,
                                            endTime, field))
        return _ret_data(code, result)
    ...
    def ThemesContent(self,
        ...
        """
        code, result = self.client.getData(vs.THEMESCONTENT %
                                           (isMain, themeID, themeName,
                                            themeSource, field))
        return _ret_data(code, result)
    ...
    def TickersByThemes(self,
        ...
        """
        code, result = self.client.getData(vs.TICKERSBYTHEMES %
                                           (themeID, themeName, beginDate,
                                            endDate, isNew, field))
        return _ret_data(code, result)
    ...
    def ThemesTickersInsert(self,
        ...
        """
        code, result = self.client.getData(vs.THEMESTICKERSINSERT %
                                           (themeID, themeName, beginDate,
                                            endDate, field))
        return _ret_data(code, result)
    ...
    def ThemesTickersDelete(self,
        ...
        """
        code, result = self.client.getData(vs.THEMESTICKERSDELETE %
                                           (themeID, themeName, beginDate,
                                            endDate, field))
        return _ret_data(code, result)
    ...
    def ReportByCategory(self, beginDate='', Category='', endDate='',
                         field=''):
        """
    ...
    def ActiveThemesInsert(self,
        ...
        """
        code, result = self.client.getData(vs.ACTIVETHEMESINSERT %
                                           (beginDate, endDate, isLatest,
                                            themeSource, field))
        return _ret_data(code, result)
    ...
    def ActiveThemesDelete(self,
        ...
        """
        code, result = self.client.getData(vs.ACTIVETHEMESDELETE %
                                           (beginDate, endDate, isLatest,
                                            themeSource, field))
        return _ret_data(code, result)
    ...
    def ThemesByNewsCompanyRel(self,
        ...
        """
        code, result = self.client.getData(vs.THEMESBYNEWSCOMPANYREL %
                                           (insertDate, newsID, beginTime,
                                            endTime, field))
        return _ret_data(code, result)
    ...
    def ThemesByNewsLF(self,
        ...
        """
        code, result = self.client.getData(vs.THEMESBYNEWSLF %
                                           (insertDate, newsID, beginTime,
                                            endTime, field))
        return _ret_data(code, result)
    ...
    def ThemesByNewsMF(self,
        ...
        """
        code, result = self.client.getData(vs.THEMESBYNEWSMF %
                                           (insertDate, newsID, beginTime,
                                            endTime, field))
        return _ret_data(code, result)
    ...
    def NewsInfoByInsertTime(self,
        ...
        """
        code, result = self.client.getData(vs.NEWSINFOBYINSERTTIME %
                                           (newsInsertDate, beginTime, endTime,
                                            field))
        return _ret_data(code, result)
    ...
    def NewsContentByInsertTime(self,
        ...
        """
        code, result = self.client.getData(vs.NEWSCONTENTBYINSERTTIME %
                                           (newsInsertDate, beginTime, endTime,
                                            field))
        return _ret_data(code, result)
    ...
    def ThemesByNewsTimeCompanyRel(self,
        ...
        """
        code, result = self.client.getData(vs.THEMESBYNEWSTIMECOMPANYREL %
                                           (publishBeginTime, publishEndTime,
                                            field))
        return _ret_data(code, result)
    ...
    def ReportContentByID(self, reportID='', field=''):
        ...
        """
        code, result = self.client.getData(vs.REPORTCONTENTBYID % (reportID,
                                                                   field))
        return _ret_data(code, result)
